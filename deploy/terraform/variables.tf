...
# viewers) — the intended posture for the public AI4 box. Set "0" for a live-agent box.
variable "demo_mode" {
  type    = string
  default = "1"
}
...
variable "app_repo_url" {
  ...
  type        = string
  default     = "https://github.com/mohammaddaoudfarooqi/mongodb-mastra-agentic-ai-qs.git"
}
