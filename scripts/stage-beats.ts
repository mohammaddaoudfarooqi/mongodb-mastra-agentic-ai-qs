...
/**
 * Presenter helpers for the two live stage beats. Each is a REAL database write — the console
 * reacts through the change stream, nothing is staged client-side.
 *
