 ...
 * would corrupt or destroy the recording — which is exactly what happens when a presenter switches
 ...
 * on one cluster indefinitely, which is what a booth/keynote needs.
 */
